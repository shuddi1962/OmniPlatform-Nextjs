        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <Link href="/forgot-password" className="text-xs text-secondary hover:text-secondary-600 transition-colors">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/register" className="font-medium text-secondary hover:text-secondary-600 transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
